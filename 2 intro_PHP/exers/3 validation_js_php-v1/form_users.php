...
<body>
	...
	<h1> Añadir contenido AudioVisual </h1>
    ...
    <p><div><label>Descripcion: </label><textarea rows='6' name="descripcion" id="descripcion" placeholder="descripcion" type="text" class="mensaje" value="">
    </textarea><span id="e_descripcion" class="styerror"></span>
    	<?php
